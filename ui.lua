    ...
    for _,page in ipairs(Elements:GetChildren()) do
        if page ~= "Template" then
            for _,Element in pairs(page:GetChildren())do
                if Element:IsA("Frame") and Element.Name ~= "Placeholder" and Element.Name ~= "SectionTitle" then
...
Topbar.Type.MouseButton1Click:Connect(function()
    ...
    if SideBarClosed then
        Topbar.Type.Image = "rbxassetid://".. 10709759610 -- 6023565894
        OpenSideBar()
    else
        Topbar.Type.Image = "rbxassetid://".. 10709759610 -- 6023565896
        CloseSideBar()
    end
end)
